...
class Cronograma extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('codigo_Cronograma, descripcion', 'required'),
			array('codigo_Cronograma', 'numerical', 'integerOnly'=>true),
			array('descripcion', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('codigo_Cronograma, descripcion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'formularios' => array(self::HAS_MANY, 'Formulario', 'codigo_Cronograma'),
		);
	}
